...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
			HttpHeaders headers, HttpStatus status, WebRequest request) {
		EnumValidationException emailException = new EnumValidationException(ex.getMessage());
		return ResponseEntity.unprocessableEntity().body(emailException.getMessage());
	}

//	@ExceptionHandler(EnumValidationException.class)
//	public ResponseEntity<Object> handleEmailException(EnumValidationException ex) {
//		EnumValidationException emailException = new EnumValidationException(ex.getMessage());
